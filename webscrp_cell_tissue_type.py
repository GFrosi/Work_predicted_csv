...
def get_info(urls):
    ...
    for adrs in urls:
        ...
        cnt = [0,0]     #cnt[1] -> tissue_type, cnt[2]-> cell_type 
...
def write_csv_file(path, epirr_list, cell_list, tissue_list):
    ...
    '''This function receives a path and three lists. It will write a csv file 
    with the infos from the 3 lists generated by the previous function'''
    
    with open(path, 'w') as f:
        writer = csv.writer(f)
        writer.writerow(["epirr_id", "cell_type", "tissue_type"])
